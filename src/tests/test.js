const ROUTES = {
  ...
  'Privacy Policy': '/pages/policy.html',
}
...
async function testPageContent() {
  ...
  const checks = [
    ...
    { page: '/pages/terms.html', name: 'Terms', check: html => html.includes('Terms of Use') || html.includes('terms-accordion') },
    { page: '/pages/policy.html', name: 'Privacy Policy', check: html => html.includes('Privacy Policy') || html.includes('policy-accordion') },
  ]
